...
const songsList = [
  {
    name: "Make Me Move",
    link: "audios/make-me-move.mp3",
    artist: "Culture Code",
    image: "images/make-me-move.jpg"
  },
  {
    name: "Where We Started",
    link: "audios/where-we-started.mp3",
    artist: "Lost Sky",
    image: "images/where-we-started.jpg",
  },
  {
    name: "On & On",
    link: "audios/on-on.mp3",
    artist: "Cartoon",
    image: "images/on-on.jpg",
  },
  {
    name: "Throne",
    link: "audios/throne.mp3",
    artist: "Rival",
    image: "images/throne.jpg",
  },
  {
    name: "Need You Now",
    link: "audios/need-you-now.mp3",
    artist: "Venemy",
    image: "images/need-you-now.jpg",
  },
  {
    name: "ve kamleya",
    link: "audios/videoplayback.m4a",
...
const isTouchDevice = () => {
  try {
    //We try tio create TouchEvent(it would fail for desktops and throw error)
...
// Format time (covert ms to seconds minutes and add 0 id less than 10)
